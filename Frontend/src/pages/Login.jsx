  ...
  return (
    <div className="h-[81.9vh] bg-zinc-900 px-12 py-8 flex items-center justify-center">
      <div className="bg-zinc-800 rounded-lg px-8 py-5 w-full md:w-3/6 lg:w-2/6">
        ...
        <p className="flex mt-4 items-center justidy-center text-zinc-200 font-semibold">
          {" "}
          Or
        </p>
        <p className="flex mt-4 items-center justidy-center text-zinc-500 font-semibold">
          {" "}
          Create an account? &nbsp;{" "}
